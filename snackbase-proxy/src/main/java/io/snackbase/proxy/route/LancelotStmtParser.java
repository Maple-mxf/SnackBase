package io.snackbase.proxy.route;
...
import io.snackbase.proxy.loader.XmlLoader;
import io.snackbase.proxy.parser.ServerParse;
import io.snackbase.proxy.route.visitor.LancelotOutputVisitor;
import io.snackbase.proxy.route.visitor.LancelotTbSuffixVisitor;
...
public class LancelotStmtParser {
    ...
    public static RouteResultset multiParse(String sql) {
        ...
        for (int i = 1; i <= tbCount; i++) {
            ...
            SQLSelectStatement selectStmt = (SQLSelectStatement) parser.parseSelect();
